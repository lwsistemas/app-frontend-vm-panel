// components/Sidebar/sidebar.config.js
import {
    LayoutDashboard,
    Server,
    Network,
...
export const SIDEBAR_MENU = [
...

    {
        group: "Network",
        items: [
            { label: "Public IPs", icon: Network, to: "/public-ips" },
            { label: "Infra / Private IPs", icon: Network, to: "/infra-ips" },
...

    {
        group: "Datacenter",
        items: [
            { label: "Inventory DC", icon: Database, to: "/inventory" },
